...
import { SafeAreaView, View, ScrollView, TextInput, Button, StyleSheet, Text, FlatList, TouchableOpacity } from 'react-native'
...
const Createdata = () => {
    ...
    const submit = () => {
        ...
        fetch(`http://192.168.100.6:3000/mahasiswa/${selectedUser.id}`, {
            method: 'PATCH',
            headers: {
